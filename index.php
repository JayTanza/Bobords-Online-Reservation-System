...
<header class="header">
   ...
   <section class="flex">
      <!-- <a href="#home" class="logo"><span>O</span>nline Reservation System.</a> -->
      <a href="#home" class="logo"><img src="img/Online-Grocery-Reservation-System.png" alt=""></a>
      <nav class="navbar">
         <a href="#home">home</a>
         <a href="#about">about</a>
         <a href="#menu">Products</a>
         <a href="#order">order</a>
         <a href="#order">Services</a>
         <a href="#faq">faq</a>
      </nav>
...
<div class="my-orders">
   ...
   <section>
      ...
      <h3 class="title"> my Reservation </h3>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="projects images/Canton1.png" alt="">
            </div>
            <div class="content">
               <h3>Flour Stick Pancit Canton 16oz(454g)</h3>
         ...
         <div class="slide">
            <div class="image">
            <img src="projects images/product4.png" alt="">
            </div>
            <div class="content">
               <h3>MODA MODA Pro-Change Black Shampoo 10.5oz(300g)</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
         ...
         <div class="slide">
            <div class="image">
               <img src="projects images/product1.png" alt="">
            </div>
            <div class="content">
               <h3>Cooked White Rice with SoyBean Paste Bibimbap 9.8oz(280g)</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Korean Street Food Warriors</h3>
...
<section class="footer">
   ...
   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>JAY TANZA</span> | all rights reserved!
   </div>
